        ...
        <div class="card-date">
          ...
          <v-list class="overflow-y-auto" nav :height="listHeight">
            <v-list-item-group active-class="primary--text">
              <v-list-item v-for="date in dates" :key="date" @click="display(date)">
                <v-list-item-avatar>
